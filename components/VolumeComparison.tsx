        ...
        <div className="grid grid-cols-12 gap-8 animate-in fade-in duration-500">
          <div className="col-span-12 lg:col-span-8">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="p-4"><h3 className="font-bold armenian-text text-slate-800">Համեմատության Աղյուսակ</h3></div>
                    ...
                    {result.comparisonTable.map((row, index) => {
                      ...
                      return (
                        <tr key={index} className="hover:bg-slate-50/50">
                          <td className="px-4 py-3 font-medium text-slate-800 armenian-text">{row.itemName}</td>
                          <td className="px-4 py-3 text-slate-500 armenian-text">{row.unit}</td>
                          ...
                          <td className={`px-4 py-3 font-bold font-mono text-right ${varianceColor}`}>{variance.toFixed(2)}</td>
                          <td className="px-4 py-3"><div className="flex justify-center"><StatusIcon variance={variance} planned={row.plannedQty} /></div></td>
                        </tr>
                      );
                    })}
                  </tbody>
