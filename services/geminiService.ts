...
`
  ...
  const prompt = `
    ...
    **ԿԱՐԵՎՈՐ ՑՈՒՑՈՒՄ**: Պատասխանը պետք է լինի խիստ համակարգված, պրոֆեսիոնալ և հեշտ ընթեռնելի: 
    Յուրաքանչյուր ուղղության համար օգտագործիր հետևյալ կառուցվածքային ձևաչափը (Point-by-point arrangement).

    ## [Ուղղության Անվանումը]
    ---
    **Խնդիր №1․ [Խնդրի հակիրճ վերնագիր]**
    - 🚩 **Նկարագրություն:** [Մանրամասն նկարագրություն, թե ինչն է սխալ նախագծում]
    - 📚 **Նորմատիվ հղում:** [ՀՀՇՆ կոդը, գլուխը և կետը]
    - 💡 **Լուծման առաջարկ:** [Հստակ քայլեր խնդիրը շտկելու համար]
    ---
    *(Կրկնիր սա յուրաքանչյուր խնդրի համար)*
  ...
  const response: GenerateContentResponse = await ai.models.generateContent({
    ...
    contents: { parts: [...normFileParts, ...projectFileParts, { text: prompt }] },
    config: {
      systemInstruction: "Դու ArchiCheck AI համակարգի գլխավոր փորձագետն ես, մասնագիտացված բազմապրոֆիլ ճարտարագիտական ռիսկերի գնահատման մեջ: Պատասխանիր հայերեն, Markdown ձևաչափով: Յուրաքանչյուր խնդիր ներկայացրու առանձին կետերով (point-by-point), որպեսզի այն լինի հեշտ ընթեռնելի: Խստորեն հետևիր չափման միավորները սովորական տեքստով գրելու կանոնին:",
      temperature: 0.1,
    }
  });
