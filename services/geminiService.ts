...
export const performAudit = async (request: AuditRequest, disciplines: PriorityTask[], auditQuestion: string): Promise<AuditResponse> => {
  ...
  const prompt = `
    ...
    **ԿԱՐԵՎՈՐ ՊԱՀԱՆՋ**: Ինֆորմացիան պետք է լինի բարձր մակարդակով համակարգված և պրոֆեսիոնալ:
    Օգտագործիր աղյուսակներ (|---|) ՄԻԱՅՆ այնտեղ, որտեղ անհրաժեշտ է տվյալները կողք կողքի ցուցադրել (օրինակ՝ Խնդիր և Լուծում)։ Մնացած դեպքերում ինֆորմացիան տեղադրիր իրար տակ (vertical point-by-point arrangement)։
    ...
    **ԾԱՅՐԱՀԵՂ ԿԱՐԵՎՈՐ (Textbook Style)**:
    - Բոլոր հաշվարկային թվերը կլորացրու ՄԻԱՅՆ 2 տասնորդական նիշով (օրինակ՝ 1.55, 90.00):
    - **Աղյուսակներ** (|---|) օգտագործիր ՄԻԱՅՆ տեխնիկական պարամետրերի համար:
    - **ԱՐԳԵԼՎՈՒՄ Է** LaTeX ($) կամ \\ նշանների օգտագործումը:
    - Չափման միավորները գրիր հայերեն տեքստով (մ³, կՎտ):
...
`
  ...
  const prompt = `
    ...
    **ԿԱՐԵՎՈՐ**: Խնդիրները և լուծումները ներկայացրու **ԱՂՅՈՒՍԱԿԻ** տեսքով (Side-by-side columns)՝ «Խնդիր» և «Լուծում» սյունակներով:
    ...
    **ԾԱՅՐԱՀԵՂ ԿԱՐԵՎՈՐ (Textbook Style)**:
    ...
    - Պուտիկները, որոնք տողերը հեռվացնում են, այլևս չօգտագործել. դրանք պետք է լինեն համապատասխան տեղում, այլ ոչ թե որպես նոր տողի սկիզբ:
    - Բոլոր թվերը կլորացրու մինչև 2 տասնորդական նիշ:
    - **ԱՐԳԵԼՎՈՒՄ Է** LaTeX ($) կամ \\ նշանների օգտագործումը:
    - Չափման միավորները գրիր հայերեն տեքստով (մ³, կՎտ):
  `;
