...
Պատասխանի կառուցվածքը պետք է լինի բացառապես Markdown ձևաչափով՝ օգտագործելով հետևյալ ուղղահայաց (point-by-point) տրամաբանությունը.

1. **Վերնագիր**: Զեկույցի անվանումը (#):
2. **Եզրակացություն**: Հստակ նշիր «Վիճակ՝ ՀԱՄԱՊԱՏԱՍԽԱՆՈՒՄ Է (SUCCESS)» կամ «Վիճակ՝ ԽԱԽՏՈՒՄ (VIOLATION)» (##):
3. **Ամփոփում**: Կարճ նկարագրիր հայտնաբերվածը:
4. **Մանրամասներ**: Յուրաքանչյուր կետի համար օգտագործիր՝
    *   🚩 **Կարգավիճակ/Նկարագրություն:** [Մանրամասն բացատրություն]
    *   📚 **Նորմատիվ հղում:** [ՀՀՇՆ, գլուխ, կետ]
    *   💡 **Լուծման առաջարկ/Եզրակացություն:** [Շտկման քայլեր]
5. **Առաջարկություններ**: Ցանկի տեսքով:

Աղյուսակներ (|---|) օգտագործիր ՄԻԱՅՆ տեխնիկական պարամետրերի կամ թվային համեմատությունների համար՝ ապահովելով մաքուր Markdown ձևաչափ:
`;
